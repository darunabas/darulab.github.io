...
44- **Daru, B.H.**, Willis, C.G., Meineke, E.K., Ronk, A., Zobel, M., Pärtel, M., Antonelli, A., Davies, T.J. & Davis, C.C. (2021) Widespread homogenization of plant communities in the Anthropocene. **_Nature Communications_** 12: 6983.<br>
  [<i class="fa fa-book" aria-hidden="true"></i> DOI](https://doi.org/10.1038/s41467-021-27186-8){: .btn .btn--small .btn--success}{:target="_blank"}
  [<i class="fa fa-download" aria-hidden="true"></i> PDF file]({{ site.baseurl}}/docs/44_Daru2021_NCOMMS.pdf){: .btn .btn--small .btn--primary}{:target="_blank"}
